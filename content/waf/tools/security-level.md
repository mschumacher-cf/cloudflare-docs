...
Security Level and threat score are deprecated. Cloudflare will remove the **Security Level** setting from the dashboard on 2024-07-01, replacing it with a toggle for [I'm Under Attack mode](/fundamentals/reference/under-attack-mode/).
